...
public class DownloadTask extends Thread implements IncomingListener,
    ...
    public DownloadTask(Peer peer, byte[] fileID, byte[] myID, boolean init, byte[] bitfield,
        ...
        if (s != null) {
            ...
            this.peer = peer;
        //this.setName("DT_"+this.peer.toString());
     ...
     * @throws java.net.UnknownHostException If the remote peer is unknown
     * @throws java.io.IOException If the connection to the remote peer fails (reset, ...)
     */
